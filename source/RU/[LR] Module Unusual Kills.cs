...
public class LevelsRanksUnusualKills : BasePlugin
{
    ...
    private void LoadModuleConfig()
    {
        ...
        {
            Server.PrintToConsole($"Ошибка при загрузке конфигурации модуля: {ex.Message}");
            _moduleConfig = new ModuleConfig();
        }
    }
    ...
    private void LoadPhrasesConfig()
    {
        ...
        {
            Server.PrintToConsole($"Ошибка при загрузке фразовой конфигурации: {ex.Message}");
            _phrasesConfig = new PhrasesConfig();
        }
    }
    ...
    public void SaveModuleConfig(ModuleConfig config, string filePath)
    {
        ...
        stringBuilder.AppendLine("# Настройка '[LR] Module Unusual Kills'");
        stringBuilder.AppendLine();
        stringBuilder.AppendLine("# Количество очков за первое убийство");
        stringBuilder.AppendLine($"PointsForFirstKill: {config.PointsForFirstKill}");     
        stringBuilder.AppendLine("# Количество очков за убийство прострелом");
        stringBuilder.AppendLine($"PointsForWallbang: {config.PointsForWallbang}"); 
        stringBuilder.AppendLine("# Количество очков за убийство с AWP без прицела");
        stringBuilder.AppendLine($"PointsForNoScopeAWP: {config.PointsForNoScopeAWP}"); 
        stringBuilder.AppendLine("# Количество очков за убийство на бегу");
        stringBuilder.AppendLine($"PointsForKillWhileRunning: {config.PointsForKillWhileRunning}"); 
        stringBuilder.AppendLine("# Количество очков за убийство в пржыке");
        stringBuilder.AppendLine($"PointsForJumpKill: {config.PointsForJumpKill}");  
        stringBuilder.AppendLine("# Количество очков за убийство ослеплённым");
        stringBuilder.AppendLine($"PointsForBlindKill: {config.PointsForBlindKill}");          
        stringBuilder.AppendLine("# Количество очков за убийство через смоук");
    ...
    public void SavePhrasesConfig(PhrasesConfig config, string filePath)
    {
        ...
        stringBuilder.AppendLine("# Сообщения модуля '[LR] Module Unusual Kills'");
        stringBuilder.AppendLine();
        stringBuilder.AppendLine("# Сообщение, отображаемое при убийстве через смоук");
        stringBuilder.AppendLine($"FirstKillMessage: \"{EscapeMessage(config.FirstKillMessage)}\""); 
        stringBuilder.AppendLine();
        stringBuilder.AppendLine("# Цвет сообщения, отображаемого при убийстве через смоук");
        ...
        stringBuilder.AppendLine();
        stringBuilder.AppendLine("# Сообщение, отображаемое при убийстве с AWP без прицела");
        stringBuilder.AppendLine($"NoScopeAWPMessage: \"{EscapeMessage(config.NoScopeAWPMessage)}\""); 
        stringBuilder.AppendLine();
        stringBuilder.AppendLine("# Цвет сообщения, отображаемого при убийстве с AWP без прицела");
        stringBuilder.AppendLine($"NoScopeAWPMessageColor: \"{config.NoScopeAWPMessageColor}\""); 
        stringBuilder.AppendLine();
        stringBuilder.AppendLine("# Сообщение, отображаемое при убийстве на бегу");
        stringBuilder.AppendLine($"KillWhileRunningMessage: \"{EscapeMessage(config.KillWhileRunningMessage)}\""); 
        stringBuilder.AppendLine();
        stringBuilder.AppendLine("# Цвет сообщения, отображаемого при убийстве на бегу");
        stringBuilder.AppendLine($"KillWhileRunningMessageColor: \"{config.KillWhileRunningMessageColor}\""); 
        stringBuilder.AppendLine();
        stringBuilder.AppendLine("# Сообщение, отображаемое при убийстве в прыжке");
        stringBuilder.AppendLine($"JumpKillMessage: \"{EscapeMessage(config.JumpKillMessage)}\""); 
        stringBuilder.AppendLine();
        stringBuilder.AppendLine("# Цвет сообщения, отображаемого при убийстве в прыжке");
        stringBuilder.AppendLine($"JumpKillMessageColor : \"{config.JumpKillMessageColor }\""); 
        stringBuilder.AppendLine();
        stringBuilder.AppendLine("# Сообщение, отображаемое при убийстве ослеплённым");
        stringBuilder.AppendLine($"BlindKillMessage: \"{EscapeMessage(config.BlindKillMessage)}\""); 
        stringBuilder.AppendLine();
        stringBuilder.AppendLine("# Цвет сообщения, отображаемого при убийстве ослеплённым");
    ...
    {
        public string FirstKillMessage { get; set; } = "первое убийство в раунде";
        public string FirstKillMessageColor { get; set; } = "{Green}";     
        public string WallbangKillMessage { get; set; } = "прострел";
        public string WallbangKillMessageColor { get; set; } = "{Green}";    
        public string NoScopeAWPMessage { get; set; } = "убийство без прицела";
        public string NoScopeAWPMessageColor { get; set; } = "{Green}";
        public string KillWhileRunningMessage { get; set; } = "убийство на бегу";
        public string KillWhileRunningMessageColor { get; set; } = "{Green}";
        public string JumpKillMessage { get; set; } = "убийство в прыжке";
        public string JumpKillMessageColor { get; set; } = "{Olive}";        
        public string BlindKillMessage { get; set; } = "убийство ослеплённым";
        public string BlindKillMessageColor { get; set; } = "{Green}";     
        public string SmokeKillMessage { get; set; } = "убийство через дым";
